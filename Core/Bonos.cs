...
namespace NgCapitalApi.Core
{
    public class Bonos
    {
        ...
        public Bonos(NgCapitalApiDbContext context
        ...
        public async Task ObtenerBonos(string token, DateTime fechaRegistro)
        {
            try
            {
                ...
                _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                    var responseCotizaciones = await _httpClient.GetAsync(authIol.UrlCotizacionesBonosArgentinaTodos/*, content*/);
                    ...
                    if (responseCotizaciones.IsSuccessStatusCode)
                    {
                        ...
                        foreach (var titulo in titulos)
                        {
                            ...
                            transformedTitulo["instrumento"] = "BONOS";
                            ...
                            transformedTitulo["descripcion"] = titulo["descripcion"].ToString().ToUpper().Trim().Replace("% VTO ", "% ").Replace("% V. ", "% ").Replace("% V.", "% ").Replace("% V ", "% ").Replace("% V", "% ").Replace(".", "").Replace(",", "").Replace("(", "").Replace(")", "").Trim();
