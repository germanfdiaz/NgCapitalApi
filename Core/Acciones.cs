...
namespace NgCapitalApi.Core
{
    public class Acciones
    {
        ...
        public Acciones(NgCapitalApiDbContext context
        ...
        public async Task ObtenerAcciones(string token, DateTime fechaRegistro)
        {
            try
            {
                ...
                _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                    var responseCotizaciones = await _httpClient.GetAsync(authIol.UrlCotizacionesAccionesArgentinaTodos/*, content*/);
                    ...
                    if (responseCotizaciones.IsSuccessStatusCode)
                    {
                        ...
                        foreach (var titulo in titulos)
                        {
                            ...
                            transformedTitulo["instrumento"] = "ACCIONES";
