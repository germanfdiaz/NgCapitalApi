...
try
{
    ...
    builder.Services.AddScoped<Cedears>();
    builder.Services.AddScoped<Bonos>();
    builder.Services.AddScoped<ObligacionesNegociables>();
    builder.Services.AddScoped<Acciones>(); 
    builder.Services.AddScoped<ObtenerDatosIol>();
    builder.Services.AddHostedService<CronIolCotizaciones>();

    // Add services to the container.
    builder.Services.AddDbContext<NgCapitalApiDbContext>(options =>
